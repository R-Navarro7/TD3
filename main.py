...
if __name__ == "__main__":
	...
	params = TrainingParams(training_params_fname="params/reach_ddpg_params.json", train=True)
	...
	replay_buffer = td3_utils.ReplayBuffer(state_dim, action_dim, max_size=params.training_params.buffer_size)
